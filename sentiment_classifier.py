...
pos_words = list()
with open ("project_files/positive_words.txt") as p_file:
    for line in p_file:
...
neg_words = list()
with open ("project_files/negative_words.txt") as n_file:
	for line in n_file:
		if line != ':' and line[0] != '\n':
...
def sentiment_classifier (result_file, data_file) :
	...
	result_file = "project_files/"+result_file+".csv"
	print(result_file)

	data_file = "project_files/"+data_file+".csv"
	print(data_file)
